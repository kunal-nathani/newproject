  ...
  <li><a href="feedback.php">Feedback</a></li>
    ...
    <div class="Login">
      ...
      <label for="Phone no 1">Phone no 1</label>
        <input type="number" id="phone1" name="phone1" placeholder="Your Phone no 1.." maxlength="10" 
        /required>
        <label for="Phone no 2">Phone no 2</label>
        <input type="number" id="phone2" name="phone2" placeholder="Your Phone no 2.." maxlength="10" 
        /required>
...
<label for="state">Choose city:</label>
      ...
      <label for="email">Email</label>
        ...
        <input type="number" id="age" name="age" placeholder="Your Age.." maxlength="3" /required>
